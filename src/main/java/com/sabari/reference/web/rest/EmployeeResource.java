...
import com.sabari.reference.domain.Employee;
import com.sabari.reference.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.sabari.reference.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "referenceapi2Employee";
