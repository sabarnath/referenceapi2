...
import com.sabari.reference.domain.Job;
import com.sabari.reference.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.sabari.reference.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class JobResource {
    ...
    private static final String ENTITY_NAME = "referenceapi2Job";
