package com.sabari.reference.web.rest;

import com.sabari.reference.Referenceapi2App;
import com.sabari.reference.domain.JobHistory;
import com.sabari.reference.repository.JobHistoryRepository;
import com.sabari.reference.service.JobHistoryService;
...
import com.sabari.reference.domain.enumeration.Language;
/**
 * Integration tests for the {@link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = Referenceapi2App.class)
